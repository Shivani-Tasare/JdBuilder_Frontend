...
@Component({
  selector: 'app-job-detail-edit-mode',
  templateUrl: './job-detail-edit-mode.component.html',
  styleUrls: ['./job-detail-edit-mode.component.scss']
})
export class JobDetailEditModeComponent implements OnInit {
